...
# LLM
NANO_MODEL: str = "gpt-5.4-nano"        # gap detection (always)
MINI_MODEL: str = "gpt-5.4-mini"        # generation default (testing)
HQ_MODEL:   str = "claude-sonnet-4-6"   # generation high-quality (demo/showcase)
